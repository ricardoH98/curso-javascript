...
document.querySelector(".paragraph") // Hace referencia al primer elemento con esa class
document.querySelectorAll(".paragraph") // Hace referencia a todos los elementos con esa class
